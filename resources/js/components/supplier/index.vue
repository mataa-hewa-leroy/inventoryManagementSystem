              ...
              <div class="card">
                ...
                <div class="table-responsive">
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      <tr v-for="supplier in filterseach" :key="supplier.id">
                        <td>{{ supplier.name }}</td>
                        <td>{{ supplier.email }}</td>
                        <td> <img :src="supplier.photo" id="photo_em" alt="Photo of Supplier"> </td>
...
export default {
    ...
    filterseach() {
        return this.suppliers.filter( supplier =>{
            return supplier.name.toLowerCase().match(this.searchTerm)
        }
        )
    },
    },
